export const I18N = {
  pl: {
    ...
    aboutEditorValue: "Claude (Frontend, nauka i tłumaczenie kodu)",
    ...
    cvAddBtn: "Dodaj CV",
    cvReplaceBtn: "Zamień CV",
    cvEditBtn: "Edytuj",
    cvDropHere: "Upuść plik PDF tutaj lub kliknij, aby wybrać",
    cvNoFile: "Brak załadowanego CV. Dodaj plik PDF.",
    cvCandidateInfo: "Informacje o kandydacie",
    cvName: "Imię i nazwisko",
    cvEmail: "E-mail",
    cvPhone: "Telefon",
    cvLinkedin: "LinkedIn",
    cvGithub: "GitHub",
    cvPortfolio: "Portfolio",
    cvSummary: "Podsumowanie",
    cvExperience: "Doświadczenie",
    cvEducation: "Edukacja",
    cvLanguages: "Języki",
    cvProjects: "Projekty",
    cvSkills: "Umiejętności",
    cvSkillsHint: "Kliknij umiejętność, aby ją usunąć",
    cvAddSkillPlaceholder: "Dodaj umiejętność...",
    cvMatchChart: "Dopasowanie do ofert w CRM",
    cvHighMatch: "Dobre dopasowanie",
    cvMedMatch: "Częściowe dopasowanie",
    cvLowMatch: "Słabe dopasowanie",
    cvNoMatch: "Brak dopasowania",
    cvParsing: "Analizowanie CV...",
    cvParseError: "Błąd przetwarzania CV",
    cvNoOffersToMatch: "Brak ofert do porównania",
  ...
  en: {
    ...
    aboutEditorValue: "Claude (Frontend, learning & code translation)",
    ...
    cvAddBtn: "Add CV",
    cvReplaceBtn: "Replace CV",
    cvEditBtn: "Edit",
    cvDropHere: "Drop PDF file here or click to select",
    cvNoFile: "No CV loaded. Add a PDF file.",
    cvCandidateInfo: "Candidate Information",
    cvName: "Full name",
    cvEmail: "E-mail",
    cvPhone: "Phone",
    cvLinkedin: "LinkedIn",
    ...
    cvProjects: "Projects",
    cvSkills: "Skills",
    cvSkillsHint: "Click a skill to remove it",
    cvAddSkillPlaceholder: "Add skill...",
    cvMatchChart: "Match to CRM Offers",
    cvHighMatch: "Good match",
    cvMedMatch: "Partial match",
    cvLowMatch: "Weak match",
    cvNoMatch: "No match",
    cvParsing: "Analyzing CV...",
    cvParseError: "CV processing error",
    cvNoOffersToMatch: "No offers to compare",
